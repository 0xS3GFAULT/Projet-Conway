conway: conway.o libisentlib.a conway.h
	gcc -Wall conway.o -o conway libisentlib.a -lm -lglut -lGL -lX11 -no-pie
...
conway.o: conway.c GfxLib.h BmpLib.h ESLib.h conway.h
	gcc -Wall -c conway.c conway.h
